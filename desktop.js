...
(c) Microsoft Corporation。保留所有权利。
    ...
    search: {
        rand: [{ name: '美男腹肌.txt', bi: 'text', ty: '文本文档' },
        { name: '帅哥.png', bi: 'image', ty: 'PNG 文件' },
        { name: '如何成为美男.docx', bi: 'richtext', ty: 'Microsoft Word 文档' },
        { name: '美男成功照片.jpg', bi: 'image', ty: 'JPG 文件' },
        { name: '历代美男.pptx', bi: 'slides', ty: 'Microsoft Powerpoint 演示文稿' },
        { name: '美男脸照.xlsx', bi: 'ruled', ty: 'Microsoft Excel 工作表' },
        { name: '成为美男第一课.svg', bi: 'image', ty: 'SVG 文件' },
        { name: '如何使用美男.doc', bi: 'richtext', ty: 'Microsoft Word 文档' }],
        search: le => {
            if (le > 0) {
